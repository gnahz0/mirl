...
# Mini HB-only training on 2 GPUs — uses default_compute_score dispatch
# Data in new unified format (no custom_reward_function needed)
#
# Checkpoints saved to: checkpoints/multiverse/hb_only_mini_grpo/
# Validation outputs:   outputs/hb_only_mini_grpo/

PROJECT_NAME='multiverse'
EXPERIMENT_NAME='hb_only_mini_grpo'
