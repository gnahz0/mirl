...
# Mini CLIMB-only training on 2 GPUs — uses default_compute_score dispatch
# Data in new unified format (no custom_reward_function needed)
#
# Checkpoints saved to: checkpoints/multiverse/climb_only_mini_grpo/
# Validation outputs:   outputs/climb_only_mini_grpo/
