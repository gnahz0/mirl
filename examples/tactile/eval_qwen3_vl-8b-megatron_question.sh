...
# Evaluate non-reasoning RL checkpoint on full test set — split: question
...
CKPT_DIR="checkpoints/tactile/qwen3vl_dapo_split_question_official"
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='eval_qwen3vl_dapo_split_question' \
