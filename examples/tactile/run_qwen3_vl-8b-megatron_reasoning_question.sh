...
# RL (GRPO) training after SFT with reasoning traces — split: question
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.path=./outputs/qwen3vl_sft_split_question_official \
    ...
    trainer.experiment_name='qwen3vl_dapo_reasoning_split_question_official' \
