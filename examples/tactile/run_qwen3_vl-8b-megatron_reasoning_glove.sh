...
# RL (GRPO) training after SFT with reasoning traces — split: glove
...
train_path="$HOME/scratch/raofu/3DHaptic/annotation_verl_split_glove_train.json"
test_path="$HOME/scratch/raofu/3DHaptic/annotation_verl_split_glove_test_mini.json"
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.path=./outputs/qwen3vl_sft_split_glove_official \
    ...
    trainer.experiment_name='qwen3vl_dapo_reasoning_split_glove_official' \
