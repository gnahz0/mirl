...
train_path=/scratch/raofu/3DHaptic/annotation_verl_split_date_train.json
test_path=/scratch/raofu/3DHaptic/annotation_verl_split_date_test_mini.json
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='qwen3vl_dapo_split_date_official' \
