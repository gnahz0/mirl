...
train_path="${DATA_DIR}/annotation_verl_reasoning_sft_split_participant_train.parquet"
test_path="${DATA_DIR}/annotation_verl_reasoning_sft_split_participant_test_mini.parquet"
...
torchrun --standalone --nnodes=1 --nproc-per-node=${NUM_TRAINERS:-4} \
    ...
    trainer.experiment_name='qwen3vl_sft_split_participant_official' \
