...
MODEL_CONFIG_CONVERTER_REGISTRY: dict[SupportedModel, Callable[[PretrainedConfig, torch.dtype], TransformerConfig]] = {
    ...
    SupportedModel.QWEN3_VL: hf_to_mcore_config_qwen2_5_vl,
    SupportedModel.QWEN3_MOE_VL: hf_to_mcore_config_qwen2_5_vl,
...
MODEL_INITIALIZER_REGISTRY: dict[SupportedModel, type[BaseModelInitializer]] = {
    ...
    SupportedModel.QWEN3_VL: Qwen25VLModel,
    SupportedModel.QWEN3_MOE_VL: Qwen25VLModel,
