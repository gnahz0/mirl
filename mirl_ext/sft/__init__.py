...
generate traces (gen_sft_targets, prompts in teacher_context) -> report
(report_traces) -> build veRL SFT parquet (build_sft_parquet). split_sft_rl
made the 50:50 split (already run); gen_sft_episodes is the few-shot episode
generator, not used in v1.
